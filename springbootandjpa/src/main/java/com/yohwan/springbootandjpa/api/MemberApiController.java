...
public class MemberApiController {
    ...
    public CreateMemberResponse saveMemverV2(@RequestBody @Valid CreateMemberReqeust request){
    ...
    @Data
    static class CreateMemberReqeust{
        @NotEmpty
        private String name;
    }
    ...
    static class CreateMemberResponse {
        ...
        public CreateMemberResponse(Long id2) {
            this.id = id2;
        }
